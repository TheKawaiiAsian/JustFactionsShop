 ...
 * ********************************************************************
 */
public class ToolsInv extends ShopInventory{

    public ToolsInv() {
        super("§e§lTOOLS", 27, itemStacks, ShopCategory.TOOLS);
    }
...

    {
        ...
        itemStacks.put(26, itemStack);
    }

    {
        for (ShopItems shopItems : ShopItems.values()) {

            if (shopItems.getShopCategory().equals(ShopCategory.TOOLS)) {
