 ...
 * ********************************************************************
 */
public class CombatInv extends ShopInventory {

    public CombatInv() {
        super("§6§lCOMBAT", 36, itemStacks, ShopCategory.COMBAT);
    }
...

    {
        ...
        itemStacks.put(35, itemStack);
    }

    {
        for (ShopItems shopItems : ShopItems.values()) {

            if (shopItems.getShopCategory().equals(ShopCategory.COMBAT)) {
